...
static void disable_rtc(uint32_t ch)
{
    ...
    static const e_stb_module_t stb_module[R_PRV_RTC_COUNT] =
    {
        MODULE_RTC0, MODULE_RTC1
    };
    ...
    /* 5: Set CLK init setting of STB driver */
    R_STB_SetClockInitStatus(stb_module[ch], CLK_OFF);
...
static void disable_usb(uint32_t ch)
{
    ...
    /* 10: Set CLK init setting of STB driver */
    R_STB_SetClockInitStatus(stb_module[ch], CLK_OFF);
