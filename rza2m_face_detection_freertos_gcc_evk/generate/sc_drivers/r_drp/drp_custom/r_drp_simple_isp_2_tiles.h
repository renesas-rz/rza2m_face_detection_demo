...
*******************************************************************************/
/*******************************************************************************
 * File Name    : r_drp_simple_isp_2_tiles.h
 * Description  : This source code is input image conversion, filter processing simply.
 *					Use 2 tiles
 * Version     : 1.10
 ******************************************************************************/
#ifndef R_DRP_SIMPLE_ISP_2_TILES_H
#define R_DRP_SIMPLE_ISP_2_TILES_H
...
r_drp_simple_isp_2_tiles_t;

#endif /* R_DRP_SIMPLE_ISP_2_TILES_H */
