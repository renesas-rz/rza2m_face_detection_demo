...
#define     CAM_VIN_PRECLIP_START_Y  ( 180u)                 /* Start line  of pre clip area (2160/2-R_BCD_CAMERA_HEIGHT)/2 = 180*/
#endif

#define     CAM_VIN_PRECLIP_WIDTH_Y  (R_BCD_CAMERA_HEIGHT)                 /* Line width of pre clip area */
#if defined(R_BCD_CAMERA_SIZE_307K)
#define     CAM_VIN_PRECLIP_START_X  (100u)                 /* Start pixel of pre clip area */
#elif defined(R_BCD_CAMERA_SIZE_1M)
#define     CAM_VIN_PRECLIP_START_X  (0u)                 /* Start pixel of pre clip area (2688/2-R_BCD_CAMERA_WIDTH)/2 = 32*/
#endif
#define     CAM_VIN_PRECLIP_WIDTH_X  (R_BCD_CAMERA_WIDTH)                 /* Pixel width of pre clip area */
...
#define     CAM_VIN_OUTPUT_IS        (R_BCD_CAMERA_WIDTH)                 /* Image Stride size */
