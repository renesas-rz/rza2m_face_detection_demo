...
#define     HD_1280_720      (3u)
#define     SELECT_MONITOR   HD_1280_720 //FWXGA_1360_768 //SVGA_800_600 //FWXGA_1360_768
...
#define     LCD_V_TOTAL             (LCD_V_VISIBLE_AREA +\
                                    ...
                                    LCD_V_BACK_PORCH)
#define     LCD_V_POLARITY          (VDC_SIG_POL_NOT_INVERTED)  /* Polarity of vertical sync pulse */
#elif ( SELECT_MONITOR == HD_1280_720 )
/* HD signal 12800x720
    Pixel clock frequency: 74.25 MHz
    Refresh rate: 60.000 Hz
    Polarity of horizontal sync pulse: Positive
    Polarity of vertical sync pulse: Positive
*/
#define     LCD_H_VISIBLE_AREA      (1280u)                     /* Horizontal visible area [pixel] */
#define     LCD_H_FRONT_PORCH       (110u)                       /* Horizontal front porch [pixel] */
#define     LCD_H_SYNC_WIDTH        (40u)                      /* Horizontal sync pulse width [pixel] */
#define     LCD_H_BACK_PORCH        (220u)                      /* Horizontal back porch [pixel] */
                                                                /* Horizontal total (one line) [pixel] */
#define     LCD_H_TOTAL             (LCD_H_VISIBLE_AREA +\
                                     LCD_H_FRONT_PORCH +\
                                     LCD_H_SYNC_WIDTH +\
...
#define     LCD_V_FRONT_PORCH       (5u)                        /* Vertical front porch [line] */
#define     LCD_V_SYNC_WIDTH        (5u)                        /* Vertical sync pulse width [line] */
#define     LCD_V_BACK_PORCH        (20u)                       /* Vertical back porch [line] */
                                                                /* Vertical total (one frame) [line] */
#define     LCD_V_TOTAL             (LCD_V_VISIBLE_AREA +\
                                     LCD_V_FRONT_PORCH +\
