...
* $Rev: 732 $
* $Date:: 2018-11-21 11:23:46 +0900#$
* Device(s)    : RZ/A2M
* Tool-Chain   : e2Studio Ver 7.0.0
*              : GCC ARM Embedded 5.4.1.20160919
* OS           : None
* H/W Platform : RZ/A2M Evaluation Board
* Description  : RZ/A2M Sample Program - Low level function of CPG module
* Operation    :
* Limitations  :
*******************************************************************************/
...
/**
 * @brief      is_nearly_equal
 *             Check two value is nearly equal or not
...
/**
 * @brief      R_CPG_InitialiseHwIf
 *             Prepare the CPG driver for operation
...
/**
 * @brief      R_CPG_UninitialiseHwIf
 *             Finalise the CPG driver for operation
 * @retval     DRV_SUCCESS Successful operate
 */
...
/**
 * @brief      R_CPG_SetMainClock
 *             Change Main clock frequency
 *             @note RZ/A2M can not adjust main clock ratio.
...
/**
 * @brief          cpg_modify_frqcr
 *                 Make frqcr value for setting clock ratio
...
/**
 * @brief          R_CPG_SetSubClockDividers
 *                 Set clock divider for suitable the specified sub clock parameter
...
/**
 * @brief          set_sub_clock_source
 *                 Make CKIOSEL and SCLKSEL value for setting external clock
...
/**
 * @brief          R_CPG_SetSubClockSource
 *                 Set clock selector for external clock
...
/**
 * @brief          R_CPG_ConfigExtClockPin
 *                 Set external CKIO clock behaviour that controls supplying
