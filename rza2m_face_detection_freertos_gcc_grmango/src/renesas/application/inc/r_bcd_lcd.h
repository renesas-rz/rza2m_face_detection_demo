...
Macro definitions
******************************************************************************/
#define R_BCD_LCD_WIDTH     (R_BCD_CAMERA_WIDTH)
#define R_BCD_LCD_HEIGHT    (R_BCD_CAMERA_HEIGHT)
...
uint32_t R_BCD_ChkLcdSwapVideoBufferReq(void);
uint32_t R_BCD_ChkLcdSwapGraphicsBufferReq(void);
